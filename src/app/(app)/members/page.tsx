    ...
    <div className="animate-fade-up">
      ...
      {showAdd && (
        <Modal title="Add New Member" onClose={() => setShowAdd(false)}>
          <form onSubmit={addUser} style={{ display: "flex", flexDirection: "column", gap: 14, flex: 1 }}>
      ...
      {editUser && (
        <Modal title="Edit Member" onClose={() => setEditUser(null)}>
          <form onSubmit={updateUser} style={{ display: "flex", flexDirection: "column", gap: 14, flex: 1 }}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
