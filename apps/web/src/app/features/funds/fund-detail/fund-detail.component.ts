      ...
      <div class="stats-row">
        <mat-card>
          <mat-card-content>
            ...
            <p class="stat-value">
              {{ fund()!.sharePrice / 100 | currency: fund()!.currency }}
            </p>
          </mat-card-content>
        </mat-card>
        <mat-card>
        ...
        <mat-card>
          <mat-card-content>
            ...
            <p class="stat-value">
              {{ fund()!.totalValue / 100 | currency: fund()!.currency }}
            </p>
          </mat-card-content>
        </mat-card>
      </div>
          ...
          <table mat-table [dataSource]="fund()!.members" class="full-width">
            ...
            <ng-container matColumnDef="percent">
              ...
              <td mat-cell *matCellDef="let m">
                {{ m.sharePercent | number: "1.2-2" }}%
              </td>
            </ng-container>
            <ng-container matColumnDef="value">
              <th mat-header-cell *matHeaderCellDef>Value</th>
              <td mat-cell *matCellDef="let m">
                {{ m.totalValue / 100 | currency: fund()!.currency }}
              </td>
            </ng-container>
          ...
          <table mat-table [dataSource]="investments()" class="full-width">
            ...
            <ng-container matColumnDef="amount">
              ...
              <td mat-cell *matCellDef="let i">
                {{ i.investedAmount / 100 | currency }}
              </td>
            </ng-container>
            <ng-container matColumnDef="status">
              <th mat-header-cell *matHeaderCellDef>Status</th>
              <td mat-cell *matCellDef="let i">
                <mat-chip [class]="i.status">{{ i.status }}</mat-chip>
              </td>
            </ng-container>
...
export class FundDetailComponent implements OnInit {
  ...
  ngOnInit() {
    this.http
      .get<FundDetail>(`/api/funds/${this.id()}`)
      .subscribe((f) => this.fund.set(f));
    this.http
      .get<any[]>(`/api/funds/${this.id()}/investments`)
      .subscribe((i) => this.investments.set(i));
  }
}
